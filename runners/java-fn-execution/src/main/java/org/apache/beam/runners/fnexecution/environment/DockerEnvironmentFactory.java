  ...
  public RemoteEnvironment createEnvironment(Environment environment) throws Exception {
    ...
    ImmutableList.Builder<String> dockerArgsBuilder =
        ImmutableList.<String>builder()
            ...
            .add("--network=host")
            .add("--volume=/Users/lukasz/Projects/apache-beam/wordcount:/Users/lukasz/Projects/apache-beam/wordcount")
            // We need to pass on thųe information about Docker-on-Mac environment (due to missing host networking on Mac)
