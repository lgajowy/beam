...
class Infrastructure {
  ...
  static void setupFlinkCluster(def context, String clusterNamePrefix, String flinkDownloadUrl, Integer workerCount, String imagesToPull, String jobServerImage) {
